...
char g_attr_mem_data[ATTR_SUM_DATA_SIZE] = {0};
...
static int8_t attr_lock(void)
{
    return 1;
}

static int8_t attr_unlock(void)
{
    return 1;
}
...
int8_t attr_mem_create(attr_mem_t *self)
{
    ...
    if(self->is_open == 0)
    {
        ...
        self->data = (char *)g_attr_mem_data;
