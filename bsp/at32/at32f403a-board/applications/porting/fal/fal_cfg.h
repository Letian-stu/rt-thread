...
#define FAL_ONCHIP_START_ADDR_BOOT1         FAL_ONCHIP_START_ADDR_APP + FAL_ONCHIP_MAX_LEN_APP
#define FAL_ONCHIP_MAX_LEN_BOOT1            (64*1024)
#define FAL_ONCHIP_START_ADDR_BOOT2         FAL_ONCHIP_START_ADDR_BOOT1 + FAL_ONCHIP_MAX_LEN_BOOT1
#define FAL_ONCHIP_MAX_LEN_BOOT2            (64*1024)
#define FAL_ONCHIP_START_ADDR_KVDB          FAL_ONCHIP_START_ADDR_BOOT2 + FAL_ONCHIP_MAX_LEN_BOOT2
...
#define FAL_NORFLASH_START_ADDR_FLASHDB     0
#define FAL_NORFLASH_MAX_LEN_FLASHDB        (1024*1024)
