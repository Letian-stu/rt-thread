...
#define air720_LINK_DELAY_TIME (30 * RT_TICK_PER_SECOND)
    ...
    while (1)
    {
        ...
        if (rt_pin_read(air720->power_status_pin) == PIN_HIGH || air720->power_status_pin == -1) //check the module_status , if moduble_status is Low, user can do your logic here
        {
