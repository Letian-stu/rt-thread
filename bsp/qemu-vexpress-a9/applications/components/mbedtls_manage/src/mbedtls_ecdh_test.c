...
int mbedtls_ecdh_test(void)
{
    ...
    mbedtls_ecp_point_write_binary(&grp, &client_pub, MBEDTLS_ECP_PF_UNCOMPRESSED, &olen, ecdh_buf, sizeof(ecdh_buf));
    dump_buf(ecdh_buf, olen);
    ...
    /* show public parameter */
    mbedtls_ecp_point_write_binary(&grp, &server_pub, MBEDTLS_ECP_PF_UNCOMPRESSED, &olen, ecdh_buf, sizeof(ecdh_buf));
    dump_buf(ecdh_buf, olen);
    ...
    /* show public parameter */
    mbedtls_mpi_write_binary(&client_secret, ecdh_buf, sizeof(ecdh_buf));
    dump_buf(ecdh_buf, olen);
    ...
    /* show public parameter */
    mbedtls_mpi_write_binary(&server_secret, ecdh_buf, sizeof(ecdh_buf));
    dump_buf(ecdh_buf, olen);
